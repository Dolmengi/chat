...
public class ChatGroupUserAdapter implements ChatGroupUserPort {
    ...
    @Override
    public ChatGroupUser getChatGroupUser(Long groupId, Long accountId) {
        return repository.findByChatGroupAndAccount(groupId, accountId).map(ChatGroupUserEntity::toDomain).orElse(null);
    }
